...
export async function generateMetadata(props: {
  ...
  return {
    ...
    description: course.description || `Enroll in ${course.title} and advance your professional skills with Social Work Nigeria.`,
    alternates: {
      canonical: url,
    },
    openGraph: {
      title: course.title,
      description: course.description || `Enroll in ${course.title} and advance your professional skills.`,
      url,
      siteName: "Social Work Nigeria",
      images: [
        {
          url: course.thumbnail_url || "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071&auto=format&fit=crop",
          width: 1200,
          height: 630,
          alt: course.title,
        },
    ...
    twitter: {
      ...
      images: [course.thumbnail_url || "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071&auto=format&fit=crop"],
    },
  };
}
...
export default async function CourseDetailsPage(props: {
  ...
  const jsonLd = {
    ...
    "provider": {
      ...
      "sameAs": process.env.NEXT_PUBLIC_BASE_URL || "https://socialworknigeria.org"
    },
    ...
    <>
      ...
      <div className="relative w-full py-16 lg:py-24 overflow-hidden bg-gray-900">
        <div
          ...
          style={{ backgroundImage: `url("${course.thumbnail_url || 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071&auto=format&fit=crop'}")` }}
        />
        <div className="absolute inset-0 z-10 bg-black/40" />
        
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12 items-center lg:items-start">
          <div className="flex-1 lg:pr-12 pt-8">
            {/* Back Button */}
            <Link
              href="/courses"
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6 leading-[1.1] drop-shadow-2xl">
              {course.title}
            </h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl leading-relaxed drop-shadow-md font-medium">
              {course.description || "Unlock premium insights, structured learning, and actionable strategies tailored for you."}
            </p>
          </div>
