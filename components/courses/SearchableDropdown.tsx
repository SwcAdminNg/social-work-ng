            ...
            <div className="p-2 border-b border-gray-100 dark:border-gray-800">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-[#0a0f0c] rounded-lg pl-9 pr-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#2D6A4F] text-gray-700 dark:text-gray-200 border border-transparent focus:border-[#2D6A4F]/30 transition-all"
                  autoFocus
                />
              </div>
            </div>
          ...
          <div className="max-h-[260px] overflow-y-auto p-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            <button
              ...
              className={`w-full text-left flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-colors ${
                !value ? "bg-[#2D6A4F]/10 text-[#2D6A4F] dark:bg-[#2D6A4F]/20 dark:text-[#52b788] font-semibold" : "text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50"
              }`}
            >
              All {placeholder}
